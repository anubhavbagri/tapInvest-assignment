...
class PurchaseView extends StatelessWidget {
      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            ...
            infoRow(context, category: 'Total Returns', value: '56,555', unit: '₹ ', isRupee: true),
            Divider(color: CustomTheme.stone300, thickness: 1),
            infoRow(context, category: 'Net Yield', value: '13.11 ', unit: '%'),
            Divider(color: CustomTheme.stone300, thickness: 1),
  ...
  Widget infoRow(
    ...
    required String unit,
      ...
      Padding(
        padding: EdgeInsets.symmetric(horizontal: CustomTheme.paddingRight, vertical: CustomTheme.paddingVertical),
        child: Row(
